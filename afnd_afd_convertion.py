...
# TEST _______________________________________________________________________________________________________________-

"""
@ EXAMPLE:

01. No. of states : ___________________________________________ 4
02. No. of transitions : ______________________________________ 2
03. state name : ______________________________________________ A
04. path : ____________________________________________________ a
05. Enter end state from state A travelling through path a : __ A B
06. path : ____________________________________________________ b
07. Enter end state from state A travelling through path b : __ A
08. state name : ______________________________________________ B
09. path : ____________________________________________________ a
10. Enter end state from state B travelling through path a : __ C
11. path : ____________________________________________________ b
12. Enter end state from state B travelling through path b : __ C
13. state name : ______________________________________________ C
14. path : ____________________________________________________ a
15. Enter end state from state C travelling through path a : __ D
16. path : ____________________________________________________ b
17. Enter end state from state C travelling through path b : __ D
18. state name : ______________________________________________ D
19. path : ____________________________________________________ a
20. Enter end state from state D travelling through path a : __ ''
21. path : ____________________________________________________ b
22. Enter end state from state D travelling through path b : __ ''
